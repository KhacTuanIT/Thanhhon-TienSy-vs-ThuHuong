    ...
    <section className={styles.hero} id="hero">
      ...
      >
        ...
        <motion.div className={styles.dateBlock} variants={fadeUp}>
          <span className={styles.dateDay}>Thứ Tư</span>
          <div className={styles.dateBig}>
            <span className={styles.dateMonth}>Tháng 7</span>
            <span className={styles.dateNum}>8</span>
            <span className={styles.dateYear}>2026</span>
          </div>
          <span className={styles.dateTime}>vào lúc 10 giờ 00 phút sáng</span>
        </motion.div>
